...
<div class="container mt-4">
    ...
    <div id="chat-box" class="border p-3 mb-3" style="height:400px; overflow-y:auto;">
        ...
        <div class="text-end"><strong>Tú:</strong> {{ $h->mensaje }}</div>
        <div><strong>Asistente:</strong> {{ $h->respuesta }}</div>
        @endforeach
    </div>
...
<div id="notification-bubble"
    style="position:fixed; bottom:80px; right:20px; background:#ff6600; color:#fff;
