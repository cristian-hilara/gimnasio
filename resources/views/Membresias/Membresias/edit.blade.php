...
<style>
    ...
    .card-header {
        background: linear-gradient(135deg, #04cb8fff 0%, #04966fff 100%);
        color: white;
    }
    .duration-selector {
        cursor: pointer;
...
<div class="container-fluid px-4">
    ...
    <div class="card shadow-sm">
        <div class="card-header">
            <i class="fas fa-edit"></i> Actualizar Información de la Membresía
        </div>
        <div class="card-body">
            <!-- Información actual -->
            <div class="row">
                <div class="col-md-12 mb-3">
                    <div class="alert alert-info">
                        ...
                        <strong>Membresía actual:</strong> {{$membresia->nombre}}
                        <span class="badge bg-info">{{$membresia->duracion_texto}}</span>
                        <span class="badge bg-success">Bs. {{number_format($membresia->precio, 2)}}</span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-2">
                                <div class="card duration-selector text-center p-3 {{$membresia->duracion_dias == 30 ? 'selected' : ''}}" 
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="card duration-selector text-center p-3 {{$membresia->duracion_dias == 90 ? 'selected' : ''}}" 
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="card duration-selector text-center p-3 {{$membresia->duracion_dias == 180 ? 'selected' : ''}}" 
                                    onclick="selectDuration(180)">
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="card duration-selector text-center p-3 {{$membresia->duracion_dias == 365 ? 'selected' : ''}}" 
                                    onclick="selectDuration(365)">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="estado" 
                            ...
                            required>
                            <option value="1" {{ old('estado', $membresia->estado) == '1' ? 'selected' : '' }}>Activa</option>
                            <option value="0" {{ old('estado', $membresia->estado) == '0' ? 'selected' : '' }}>Inactiva</option>
                        </select>
                        @error('estado')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea 
                            ...
                            placeholder="Describe los beneficios de esta membresía...">{{old('descripcion', $membresia->descripcion)}}</textarea>
                        @error('descripcion')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="alert alert-secondary">
                            <small>
                                ...
                                {{$membresia->created_at->format('d/m/Y H:i')}}
                                <br>
                                <strong><i class="fas fa-clock"></i> Última actualización:</strong> 
                                {{$membresia->updated_at->format('d/m/Y H:i')}}
                            </small>
                        </div>
                    </div>
                </div>
