...
<div class="card p-4">
    <div class="card-body">
        ...
        <form action="{{ route('administrador.actualizar',$admin->id)}}" method="post">
            @csrf
            @method('PUT')
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="area_responsabilidad" id="area_responsabilidad" class="form-control" value="{{old('area_responsabilidad',$admin->area_responsabilidad)}}" required>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="usuario_search" class="form-control" placeholder="Escribe para buscar usuario" autocomplete="off"
                        value="{{ old('usuario_search', $admin->usuario->nombre) }} {{ old('usuario_search', $admin->usuario->apellido ?? '') }}" required>

                    <input type="hidden" name="usuario_id" id="usuario_id" value="{{ old('usuario_id',$admin->usuario_id) }}">
